...
from utils import save_results_as_checkpoint
...
if __name__ == '__main__':
    ...
    save_results_as_checkpoint(output_path, device_name, training_params, optimizer_types, train_gpu_mem_usage)
