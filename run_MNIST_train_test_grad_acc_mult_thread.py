...
training_params = [ 
                    ...
                    [16,128, 1],
                    [16, 64, 1],[16, 64, 2],
                    [16, 32, 1],[16, 32, 2],[16, 32, 4],
                    [16, 16, 1],[16, 16, 2],[16, 16, 4],[16, 16, 8],
                    [16,  8, 1],[16,  8, 2],[16,  8, 4],[16,  8, 8],[16,  8,16],
                    [16,  4, 1],[16,  4, 2],[16,  4, 4],[16,  4, 8],[16,  4,16],[16,  4,32],
                    ...
                    [ 4,512, 1],
                    [ 4,256, 1],[ 4,256, 2],
                    [ 4,128, 1],[ 4,128, 2],[ 4,128, 4],
                    [ 4, 64, 1],[ 4, 64, 2],[ 4, 64, 4],[ 4, 64, 8],
                    [ 4, 32, 1],[ 4, 32, 2],[ 4, 32, 4],[ 4, 32, 8],[ 4, 32,16],
                    [ 4, 16, 1],[ 4, 16, 2],[ 4, 16, 4],[ 4, 16, 8],[ 4, 16,16],[ 4, 16, 32],
                    [ 4,  8, 1],[ 4,  8, 2],[ 4,  8, 4],[ 4,  8, 8],[ 4,  8,16],[ 4  ,8, 32],[ 4,  8, 64],
                    [ 4,  4, 1],[ 4,  4, 2],[ 4,  4, 4],[ 4,  4, 8],[ 4,  4,16],[ 4,  4, 32],[ 4,  4, 64],[ 4,  4, 128],
                  ]
